...
class Client(Iface):
    ...
    def predict(self, articles):
        ...
        """
        self.send_predict(articles)
        return self.recv_predict()

    def send_predict(self, articles):
...
class Processor(Iface, TProcessor):
    ...
    def process_predict(self, seqid, iprot, oprot):
        ...
        result = predict_result()
        try:
            result.success = self._handler.predict(args.articles)
...
class predict_args(object):
    ...
    def write(self, oprot):
        ...
        if self.articles is not None:
            oprot.writeFieldBegin('articles', TType.LIST, 1)
...
predict_args.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'articles', (TType.STRUCT, [Article, None], False), None, ),  # 1
)
...
predict_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [Summarization, None], False), None, ),  # 0
)
